...
opcode_entry opcode_table [512] = {
  ...
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(mov_I2r,mov), IDEX(mov_I2r,mov), IDEX(mov_I2r,mov), IDEX(mov_I2r,mov),
  /* 0xbc */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(mov_I2r,mov), IDEX(mov_I2r,mov), IDEX(mov_I2r,mov), IDEX(mov_I2r,mov),
